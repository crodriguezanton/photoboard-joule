//Photoboard Realsense main file

//Saves to main directory in disk the color and depth picture
...
int main() try
{
    ...
    {
        std::stringstream ss;
        ss << "photoboard-image-" << captured.stream << "1.png";
    ...
    {
        std::stringstream ss;
        ss << "photoboard-image-" << captured.stream << "2.png";
